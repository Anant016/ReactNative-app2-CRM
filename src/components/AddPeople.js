  ...
  render() {
    return (
      <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <Text style={{fontWeight:'bold',marginBottom:30}}>Add a new contact</Text>
          <MKTextField 
          ...
          <View style={styles.addButton}>
            <AddButton onPress={this.onPress.bind(this)} />
          </View>
        </View>
      </ScrollView>
    );
...
const mapStateToProps=state=>{
  ...
  return{
    first_name,last_name,phone,email,company,notes,project
  };
}
